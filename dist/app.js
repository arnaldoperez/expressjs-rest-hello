...
var PUBLIC_URL = (0, utils_1.url)(PORT);
...
app.get('/', function (req, res) { return (0, utils_1.renderIndex)(app, PUBLIC_URL).then(function (html) { return res.status(404).send(html); }); });
